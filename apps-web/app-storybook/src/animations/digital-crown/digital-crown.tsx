  ...
  return (
    <>
      ...
      <button
        ...
        className={`
          fixed top-4 right-4 z-20 flex size-10 items-center justify-center rounded-full transition-colors
          ${isMuted ? 'bg-neutral-800 text-neutral-400 hover:bg-neutral-700' : 'bg-cyan-600 text-white hover:bg-cyan-500'}
        `}
